...
export default function CatalogModal({ perfume, currency, onClose }: CatalogModalProps) {
      ...
      >
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          <div className="bg-white/[0.03] rounded-xl p-3 text-center">
            ...
            <p className="text-[11px] text-neutral-500 mt-1">Preço aprox.</p>
          </div>
          <div className="bg-white/[0.03] rounded-xl p-3 text-center">
          ...
          <div className="bg-white/[0.03] rounded-xl p-3 text-center">
            <p className="text-lg font-display capitalize">{perfume.sillage}</p>
            <p className="text-[11px] text-neutral-500 mt-1">Projeção</p>
          </div>
        </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-6 text-sm">
          ...
          <div>
            <p className="text-neutral-500 mb-1">Duração</p>
            <p className="text-neutral-200">{perfume.longevity}</p>
          </div>
          <div>
